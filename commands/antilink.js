...
cmd({
  ...
  if (action === 'on') {
    ...
    await m.reply("✅ *Anti-link enabled!* Links will now be auto-deleted 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 ☠︎︎ Hamza 𝑴𝑫 ☠︎︎.");
  } 
  else if (action === 'off') {
    config.ANTI_LINK = 'false';
    await m.reply("❌ *Anti-link disabled!* Links are now allowed 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 ☠︎︎ Hamza 𝑴𝑫 ☠︎︎.");
  } 
  else {
