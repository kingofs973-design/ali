...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('Hamza', {
        font: 'Standard',
    ...
    console.log(chalk.green('   HAMZA-MD 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting Hamza system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅Hamza bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('Hamza BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅Hamza тɛℓɛɢяαм вσт: Active') : chalk.red('❌Hamza тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ Hamza system is ready and running!\n'));
    }
