...
global.owner = ['234']
global.xprefix = '.'
global.gambar = "https://i.ibb.co/67LMyJcq/jawadmd.jpg"
global.OWNER_NAME = "@Hamzahacr" //
global.DEVELOPER = ["7848300179"] //
global.BOT_NAME = "☠︎︎ Hamza 𝑴𝑫 ☠︎︎︎"
...
global.creatorName = "☠︎︎ 𓆩Hamza 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍𓆪 ☠︎︎'"
global.footer = "☠︎︎ Hamza 𝑴𝑫 ☠︎︎" //footer section
global.link = "https://whatsapp.com/channel/0029Vb6iopUDzgTJuzPCk32V"
global.autobio = true//auto update bio
global.botName = "☠︎︎ Hamza 𝑴𝑫 ☠︎︎"
global.version = "V2"
global.botname = "☠︎︎ Hamza 𝑴𝑫 ☠︎︎"
global.author = "༒︎ 𝑺𝑯𝑨𝑫𝑶𝑾 ༒︎"
global.themeemoji = '🤞'
global.wagc = 'https://whatsapp.com/channel/0029Vb6iopUDzgTJuzPCk32V'
global.thumbnail = 'https://i.ibb.co/67LMyJcq/jawadmd.jpg'
global.richpp = 'https://i.ibb.co/67LMyJcq/jawadmd.jpg'
...
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *Hamza* — 𝙊𝙧 𝙗𝙚 𝙚𝙧𝙖𝙨𝙚𝙙 𝙗𝙮 𝙙𝙚𝙛𝙖𝙪𝙡𝙩.  🔗 *No entry without approval.*`
  global.mess = {
wait: "```☠️ WAIT FOR  ☠︎︎ Hamza 𝑴𝑫 ☠︎︎😈 ⚡ *Darkness intensifies...*  💀 *Brace yourself — The Hamza is rising.*```",
   success: "✔️ 𝗦𝗨𝗖𝗖𝗘𝗦𝗦 𝗕𝗬 ☠︎︎ Hamza 𝑴𝑫 ☠︎︎ ⚔️`  🔥 *Mission complete. The Void accepts your command.*",
   on: "`✔️☠︎︎ Hamza 𝑴𝑫 ☠︎︎𝗔𝗖𝗧𝗜𝗩𝗘 ⚔️`  🔥 *The Hamza is unleashed. Power running at full force.*  🕳️ *Enter if you dare.*", 
   ...
   off: "`❌ ☠︎︎ Hamza 𝑴𝑫 ☠︎︎𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗢𝗙𝗙 ⚰️`  🕳️ *The Hamza has gone dark. All systems offline.*  ⚡ *Recharge and prepare for the next awakening.*",
   query: {
...
global.onlyowner = `\`[ 🤞 ] ☠︎︎ Hamza 𝑴𝑫 ☠︎︎ \` \n*
...
global.database = `\`[ 👑 ] ☠︎︎ Hamza 𝑴𝑫 ☠︎︎ 😙 \` \n*
